...
parser.add_argument('preprocessor_path_player_points', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_points', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_turnovers', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_turnovers', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_steals', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_steals', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_assists', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_assists', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_blocks', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_blocks', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_tpm', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_tpm', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_rebounds', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_rebounds', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_fga', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_fga', type=str, help='Model/Processor Path for category')
parser.add_argument('preprocessor_path_player_ftm', type=str, help='Model/Processor Path for category')
parser.add_argument('model_path_player_ftm', type=str, help='Model/Processor Path for category')
parser.add_argument('historical_data_path', type=str, help='Filepath of the historical data used for prediction')
parser.add_argument('predictions_output_file', type=str, help='Output file path for predictions')


# Parse arguments
args = parser.parse_args()
preprocessor_path_player_points = args.preprocessor_path_player_points
model_path_player_points = args.model_path_player_points
preprocessor_path_player_turnovers = args.preprocessor_path_player_turnovers
model_path_player_turnovers = args.model_path_player_turnovers
preprocessor_path_player_steals = args.preprocessor_path_player_steals
model_path_player_steals = args.model_path_player_steals
preprocessor_path_player_assists = args.preprocessor_path_player_assists
model_path_player_assists = args.model_path_player_assists
preprocessor_path_player_blocks = args.preprocessor_path_player_blocks
model_path_player_blocks = args.model_path_player_blocks
preprocessor_path_player_tpm = args.preprocessor_path_player_tpm
model_path_player_tpm = args.model_path_player_tpm
preprocessor_path_player_rebounds = args.preprocessor_path_player_rebounds
model_path_player_rebounds = args.model_path_player_rebounds
preprocessor_path_player_fga = args.preprocessor_path_player_fga
model_path_player_fga = args.model_path_player_fga
preprocessor_path_player_ftm = args.preprocessor_path_player_ftm
model_path_player_ftm = args.model_path_player_ftm
...
# numerical_features_preproc = ['height',  'player_min_in_minutes', 'player_min_in_seconds', 
...
# # Define the features used in the model
# numerical_features_player_points = ['height', 'weight', 'player_fgm', 'player_fga',
#                       'player_ftm',  'player_min_in_minutes', 'player_min_in_seconds', 
#                       'player_fta', 'player_tpm', 'player_tpa',
#                       'player_offReb', 'player_defReb', 'player_totReb',
#                       'player_assists', 'player_pFouls', 'player_steals',
#                       'player_turnovers', 'player_blocks', 'player_plusMinus',
...
# numerical_features_ftm = ['height', 'weight', 'player_fgm', 'player_points',
#                       'player_fga',  'player_min_in_minutes', 'player_min_in_seconds', 
#                       'player_fta', 'player_tpm', 'player_tpa',
#                       'player_offReb', 'player_defReb', 'player_totReb',
#                       'player_assists', 'player_pFouls', 'player_steals',
#                       'player_turnovers', 'player_blocks', 'player_plusMinus',
...
# features_minutes = numerical_features_minutes + categorical_features
