...
#     else:
#         return np.nan  # Default case, should not happen if all data is correct
...
# Train the model
model.fit(X_train_processed, y_train, epochs=100, batch_size=32, validation_split=0.2, callbacks=[early_stopping, model_checkpoint])
